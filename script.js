...
const PRODUCTS = [
  ...
  {
    id: 'VH-030', audience: 'homme', group: 'shoes', name: 'Sneakers Dior Runner — Gris Duo', category: 'Chaussures / Sneakers',
    price: null, oldPrice: null, sizes: ['39', '40', '41', '42', '43', '44', '45'], colors: ['Gris', 'Noir', 'Blanc'],
    stockLevel: 'inquiry', image: 'assets/products/men/sneakers-dior-b30-grey-double.jpg', gallery: [],
    description: 'Visuel duo gris, noir et blanc, transformé en annonce indépendante pour une réservation plus claire.',
    material: 'Mesh technique · empiècements structurés', fit: 'Pointure normale', detail: 'Annonce séparée · modèle à confirmer sur Snap',
    featured: false, topRequested: false, isNew: true,
  },
  {
    id: 'VH-031', audience: 'homme', group: 'shoes', name: 'Sneakers Dior Runner — White Profile', category: 'Chaussures / Sneakers',
    price: null, oldPrice: null, sizes: ['39', '40', '41', '42', '43', '44', '45'], colors: ['Blanc', 'Gris argent'],
    stockLevel: 'inquiry', image: 'assets/products/men/sneakers-dior-b30-white-single.jpg', gallery: [],
    description: 'Profil blanc premium, désormais isolé en fiche dédiée pour éviter toute confusion entre modèles.',
    material: 'Mesh blanc · renforts argentés', fit: 'Pointure normale', detail: 'Profil unique · disponibilité sur Snap',
    featured: false, topRequested: false, isNew: true,
  },
  {
    id: 'VH-032', audience: 'homme', group: 'shoes', name: 'New Balance 1906R — White 1906', category: 'Chaussures / Sneakers',
    price: null, oldPrice: null, sizes: ['39', '40', '41', '42', '43', '44', '45'], colors: ['Blanc', 'Gris'],
    stockLevel: 'inquiry', image: 'assets/products/men/sneakers-new-balance-white-1906.jpg', gallery: [],
    description: 'New Balance blanche en annonce séparée, avec lecture produit directe et réservation indépendante.',
    material: 'Mesh blanc · renforts argentés', fit: 'Pointure normale', detail: 'Fiche produit dédiée · confort running',
    featured: false, topRequested: false, isNew: true,
  },
  {
    id: 'VH-033', audience: 'homme', group: 'shoes', name: 'On Running Cloudtilt — Bleu Brume', category: 'Chaussures / Sneakers',
    price: null, oldPrice: null, sizes: ['39', '40', '41', '42', '43', '44', '45'], colors: ['Bleu brume', 'Blanc', 'Gris'],
    stockLevel: 'inquiry', image: 'assets/products/men/sneakers-on-cloudtilt-blue.jpg', gallery: [],
    description: 'Coloris bleu brume extrait de l’ancienne galerie et ajouté comme annonce indépendante.',
    material: 'Mesh technique · panneaux translucides', fit: 'Running fit', detail: 'Semelle Cloud · annonce dédiée',
    featured: false, topRequested: false, isNew: true,
  },
  {
    id: 'VH-034', audience: 'homme', group: 'clothing', name: 'T-shirt VISION Signature V — Noir Vert', category: 'Vêtements / T-shirts',
    price: null, oldPrice: null, sizes: ['S', 'M', 'L', 'XL', 'XXL'], colors: ['Noir', 'Vert', 'Rose'],
    stockLevel: 'low', image: 'assets/products/men/shirt-vision-v-green-black-back.jpg', gallery: [],
    alt: 'T-shirt homme noir VISION avec grand V vert au dos',
    description: 'T-shirt noir avec grand V graphique vert au dos, halo violet et présence visuelle forte.',
    material: 'Coton premium', fit: 'Coupe droite', detail: 'Visuel dos signature · drop VISION',
    featured: true, topRequested: true, isNew: true,
  },
  {
    id: 'VH-035', audience: 'homme', group: 'clothing', name: 'T-shirt VRK Graphic — Mint', category: 'Vêtements / T-shirts',
    price: null, oldPrice: null, sizes: ['S', 'M', 'L', 'XL', 'XXL'], colors: ['Mint', 'Turquoise', 'Noir'],
    stockLevel: 'low', image: 'assets/products/men/shirt-vrk-mint.jpg', gallery: [],
    alt: 'T-shirt homme VRK mint avec détails turquoise',
  ...
  {
    id: 'VH-036', audience: 'homme', group: 'clothing', name: 'T-shirt VRK Mizuno — Graphite Volt', category: 'Vêtements / T-shirts',
    price: null, oldPrice: null, sizes: ['S', 'M', 'L', 'XL', 'XXL'], colors: ['Graphite', 'Noir', 'Jaune volt'],
    ...
    description: 'T-shirt graphite à motif hexagonal, signature volt et lecture très sportive.',
    material: 'Textile respirant', fit: 'Coupe sport', detail: 'Motif technique · contraste volt',
    featured: false, topRequested: true, isNew: true,
  },
  {
    id: 'VH-037', audience: 'homme', group: 'clothing', name: 'T-shirt VRK Peace — Blanc Rouge', category: 'Vêtements / T-shirts',
    price: null, oldPrice: null, sizes: ['S', 'M', 'L', 'XL', 'XXL'], colors: ['Blanc', 'Rouge', 'Noir'],
    ...
    description: 'T-shirt blanc avec visuels rouge devant et dos, rendu clair et très lisible en catalogue.',
    material: 'Coton premium', fit: 'Coupe droite', detail: 'Face + dos visibles · graphisme rouge',
    featured: false, topRequested: false, isNew: true,
  },
  {
    id: 'VH-038', audience: 'homme', group: 'clothing', name: 'T-shirt VRK Limited V — Noir Rouge', category: 'Vêtements / T-shirts',
    price: null, oldPrice: null, sizes: ['S', 'M', 'L', 'XL', 'XXL'], colors: ['Noir', 'Rouge', 'Blanc'],
    ...
    description: 'T-shirt noir édition limitée avec grand V rouge au dos, pensé comme pièce forte du drop.',
    material: 'Coton premium', fit: 'Coupe droite', detail: 'Visuel dos rouge · lightweight division',
    featured: true, topRequested: true, isNew: true,
  },
  {
    id: 'VH-039', audience: 'homme', group: 'clothing', name: 'T-shirt VRK Peace — Noir Bleu', category: 'Vêtements / T-shirts',
    price: null, oldPrice: null, sizes: ['S', 'M', 'L', 'XL', 'XXL'], colors: ['Noir', 'Bleu'],
    ...
    description: 'T-shirt noir avec visuel bleu devant/dos, sobre, premium et facile à intégrer en Pack Outfit.',
